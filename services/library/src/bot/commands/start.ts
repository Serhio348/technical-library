...
function welcomeText(): string {
  return (
    ...
    "<b>Когда нужен интернет (позже, в «Чат ИИ»):</b>\n" +
    "• явно: «погугли», «в интернете», «найди в сети»\n" +
    "• свежесть: сегодня / курс / погода / новости\n" +
    "• год ≥ текущего\n" +
    "В режиме «По документам» интернет не включается.\n\n" +
